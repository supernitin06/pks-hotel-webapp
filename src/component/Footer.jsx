...
export default function Footer() {
    return (
        <footer
            ...
            <div
                className="flex items-center justify-center   flex-wrap border-neutral-200  bg-[#6FB60B] lg:justify-around  py-5 ">
                <div className="  text-[30px] font-[700] pb-8  text-nowrap  font-poppins md:mr-[250px] md:pb-0 ">
                    <span>Subscirbe Newsletter!</span>
                </div>
                <div>
                    <button className="bg-[#6FB60B] text-white rounded-3xl px-9 font-bold  py-2 hover:bg-black transition duration-300 border-[2px]  focus:ring-2 focus:ring-white focus:outline-none">
                        Subscribe Now
                    </button>
            ...
            <div className="   text-left  bg-[url('https://wp.hostlin.com/nilachol/images/background/6.jpg')]  bg-no-repeat bg-left bg-cover   ">
                ...
                <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4 px-5 py-24  md:px-[170px] md:py-[50px] z-20  bg-black bg-black/80 ">
                    {/* <!-- TW Elements section --> */}
                    <div className=" md:py-5 ">
                        <img className='z-30 ' src='https://wp.hostlin.com/nilachol/images/logo/logo2.png'></img>
                    ...
                    <div className=" md: mt-3  ">
                        ...
                        <p className="mb-2 mt-[30px] ">
                            <a className="text-neutral-600 dark:text-neutral-200">Bedroom</a>
                        </p>
                        <p className="mb-2">
                            <a className="text-neutral-600 dark:text-neutral-200">Parking</a>
                        </p>
                        <p className="mb-2">
                            <a className="text-neutral-600 dark:text-neutral-200">Bathroom</a>
                        </p>
                        <p className="mb-2">
                            <a className="text-neutral-600 dark:text-neutral-200">Swimming Pool</a>
                        </p>
                        <p>
                            <a className="text-neutral-600 dark:text-neutral-200">Restaurant</a>
                        </p>
                    </div>
                    ...
                    <div className=" md: mt-3 ">
                        ...
                        <p className="mb-2">
                            <a className="text-neutral-600 dark:text-neutral-200">Team</a>
                        </p>
                        <p className="mb-2">
                            <a className="text-neutral-600 dark:text-neutral-200">Service</a>
                        </p>
                        <p>
                    ...
                    <div className=" md: mt-3  ">
                        ...
                        <div className='flex flex-row space-x-1  '>
                            ...
                            <div className='mt-[30px]'>
                                <img src='https://wp.hostlin.com/nilachol/images/resource/i2.jpg'></img>
                            </div>
                            <div className='mt-[30px]'>
            ...
            <div className=" p-6 text-center bg-black ">
                <span className='text-gray-500' >Copyrights © 2018 All Rights Reserved by </span>
                <a
